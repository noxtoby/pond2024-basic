Copied from the [conference-website-template](https://mikepierce.github.io/conference-website-template/) HTML/CSS website template by [Mike Pierce](https://mikepierce.github.io), intended for a small academic or technology conference or seminar.

The template is quick to deploy and straightforward (if somewhat laborious compared to GitHub markdown) to customize.
